...
QtObject {
    ...
    property string _b_buttonBackgroundColor: "#5fe300"
    property string _b_buttonBackgroundColorHover: "#55cc00"
    ...
    property string _w_buttonBackgroundColor: "#5fe300"
    property string _w_buttonBackgroundColorHover: "#55cc00"
